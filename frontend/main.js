...
■ 전원 사유 및 임상적 판단
환자의 D-Dimer 상승(2.5 ng/mL)과 LDH 증가(450 U/L),
Creatinine 상승(1.8 mg/dL)이 관찰되어 혈전색전증 및
        ...
        <div class="max-w-7xl mx-auto">
          <div class="flex items-center justify-between mb-4">
            ...
            <div class="flex items-center space-x-2">
              <a href="/monitoring.html" target="_blank" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors">
                모니터링 대시보드
              </a>
              <button
                @click="goBack"
